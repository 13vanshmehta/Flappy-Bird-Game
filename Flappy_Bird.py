...
if __name__ == "__main__":
    ...
    # Game sounds
    GAME_SOUNDS['die'] = pygame.mixer.Sound('Flappy Bird Game/gallery/audio/die.wav')
    GAME_SOUNDS['hit'] = pygame.mixer.Sound('Flappy Bird Game/gallery/audio/hit.wav')
    GAME_SOUNDS['point'] = pygame.mixer.Sound('Flappy Bird Game/gallery/audio/point.wav')
    GAME_SOUNDS['swoosh'] = pygame.mixer.Sound('Flappy Bird Game/gallery/audio/swoosh.wav')
    GAME_SOUNDS['wing'] = pygame.mixer.Sound('Flappy Bird Game/gallery/audio/wing.wav')
